...
const file_proto_course_category_proto_rawDesc = "" +
	...
	"\x0eCreateCategory\x12\x19.pb.CreateCategoryRequest\x1a\f.pb.Category\"\x00\x12O\n" +
	...
	"\x0eListCategories\x12\t.pb.blank\x1a\x18.pb.CategoryListResponse\"\x00\x125\n" +
...
var file_proto_course_category_proto_depIdxs = []int32{
	0, // 0: pb.CategoryListResponse.categories:type_name -> pb.Category
